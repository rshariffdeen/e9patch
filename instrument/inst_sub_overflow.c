                        ...
                        int64_t ub, const char *asm_str, const void *addr)
{
    ...
    if (option_debug && overflow)
    {
        ...
        write_string(stream, "\33[31mDETECT SUB OVERFLOW\33[0m: \33[32m");
 ...
 */
void sub_r64r64(const int64_t *S1, const int64_t *S2, int64_t *D,
 ...
 */
void sub_r32r32(const int32_t *S1, const int32_t *S2, int32_t *D,
                uint16_t *rflags, const char *asm_str, const void *addr)
{
