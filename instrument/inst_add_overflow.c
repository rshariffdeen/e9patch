 ...
 */
void add_r64r64(const int64_t *S1, const int64_t *S2, int64_t *D,
...
/*
 * Safe addition (64bit three operand form)
 */
void add_imm32r64r64(const int32_t *S1, const int64_t *S2, int64_t *D,
                     uint16_t *rflags, const char *asm_str, const void *addr)
{
    safe_add((int64_t)*S1, *S2, rflags, INT64_MIN, INT64_MAX, asm_str,
                  addr);
}
 ...
 */
void add_r32r32(const int32_t *S1, const int32_t *S2, int32_t *D,
                uint16_t *rflags, const char *asm_str, const void *addr)
{
...
/*
 * Safe addition (32bit three operand form)
 */
void add_imm32r32r32(const int32_t *S1, const int32_t *S2, int32_t *D,
                     uint16_t *rflags, const char *asmStr, const void *addr)
__attribute__((__alias__("add_r32r32")));
